...
func (d *MetadataStoreDgraph) GetPoolRegistrations(
...
func (d *MetadataStoreDgraph) GetStakeRegistrations(
	stakingKey []byte,
	txn *dgo.Dgraph,
...
func (d *MetadataStoreDgraph) SetPoolRegistration(
...
func (d *MetadataStoreDgraph) SetPoolRetirement(
...
func (d *MetadataStoreDgraph) SetStakeDelegation(
...
func (d *MetadataStoreDgraph) SetStakeDeregistration(
...
func (d *MetadataStoreDgraph) SetStakeRegistration(
