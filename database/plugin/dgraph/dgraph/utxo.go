...
func (d *MetadataStoreDgraph) GetUtxo(
	txId []byte,
	idx uint32,
	txn *dgo.Dgraph,
) (models.Utxo, error) {
...
func (d *MetadataStoreDgraph) GetUtxosByAddress(
	addr ledger.Address,
	txn *dgo.Dgraph,
) ([]models.Utxo, error) {
	var ret []models.Utxo
	// Build sub-query for address
	var addrQuery *dgo.Dgraph
...
func (d *MetadataStoreDgraph) DeleteUtxo(
	utxo any,
	txn *dgo.Dgraph,
) error {
...
func (d *MetadataStoreDgraph) DeleteUtxos(
	utxos []any,
	txn *dgo.Dgraph,
) error {
