...
// CommitTimestamp represents the dgraph table used to track the current commit timestamp
...
func (d *MetadataStoreDgraph) GetCommitTimestamp() (int64, error) {
	// Get value from dgraph
...
func (d *MetadataStoreDgraph) SetCommitTimestamp(
	txn *dgo.Dgraph,
	timestamp int64,
) error {
